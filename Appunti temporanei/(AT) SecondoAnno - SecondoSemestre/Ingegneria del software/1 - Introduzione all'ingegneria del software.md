...
> [!info] Definizione ingegneria del software
...
Quello che quindi caratterizza l'ingegneria del software è il **focus sul processo**, indipendentemente dal prodotto software. 
...
## Fattore tempo
Il fattore tempo è detto **time to market** ed è il tempo che intercorre dall'idea iniziale al rilascio del prodotto, ed il fattore critico maggiore per alcuni progetti, poiché meno veloci si è a rilasciare un prodotto, maggiormente un concorrente potrebbe anticipare l'idea.
